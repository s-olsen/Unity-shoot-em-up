Shader "Roystan/Cel Shader"
{
	Properties
	{
		...
		// Control how smoothly the rim blends when approaching unlit parts of the object's surface
	...
	SubShader
	{
		Pass
		{
			// Setup our pass to use Forward rendering, only receiving data on the main directional light and ambient light.
			Tags
			{
			...
			float4 frag (v2f i) : SV_Target
			{
				...
				// Lighting below is calculated using Blinn-Phong with values thresholded to create a "toon" look.
